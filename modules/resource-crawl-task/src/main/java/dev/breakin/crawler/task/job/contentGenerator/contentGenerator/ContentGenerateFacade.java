package dev.breakin.crawler.task.job.contentGenerator.contentGenerator;

import dev.breakin.crawler.task.job.contentGenerator.contentGenerator.detail.*;
import dev.breakin.crawler.task.job.contentGenerator.contentGenerator.detail.explanation.*;
import dev.breakin.crawler.task.job.contentGenerator.contentGenerator.detail.hiringProcess.*;
import dev.breakin.crawler.task.job.contentGenerator.contentGenerator.detail.pay.JobPayDetailExtractor;
import dev.breakin.crawler.task.job.contentGenerator.contentGenerator.detail.pay.JobPayExtractor;
